...
stringID_table_t animTable [MAX_ANIMATIONS+1] =
{
	...
	ENUM2STRING(BOTH_SHOOTDODGE_F),			//#
	ENUM2STRING(BOTH_SHOOTDODGE_B),			//#
	ENUM2STRING(BOTH_SHOOTDODGE_L),			//#
	ENUM2STRING(BOTH_SHOOTDODGE_R),			//#
	ENUM2STRING(BOTH_GETUP_L),			//#
	ENUM2STRING(BOTH_GETUP_R),			//#
	ENUM2STRING(BOTH_FORCE_GETUP_L),			//#
	ENUM2STRING(BOTH_FORCE_GETUP_R),			//#
	ENUM2STRING(BOTH_FORCE_GETUP_L2),			//#
	ENUM2STRING(BOTH_FORCE_GETUP_R2),			//#
